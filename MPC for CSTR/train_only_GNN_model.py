...
torch.save(model.state_dict(), "Model_deep_Nd_{}_Nl_{}_lr_{}_act_{}_BS_{}_hid_{}_MSE_{}_MAS_{}.pth".format(N_data,N_layer,lr,act,batch_size,N_hid, round(avg_mse,2), round(avg_mae,2)))
